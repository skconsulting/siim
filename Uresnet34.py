...
##    print(get_layer_number(backbone, 10))
#    print(skip_layers)
#    for l in skip_layers:
...
def UResNet34T(input_shape=(None, None, 3), classes=1, decoder_filters=16, decoder_block_type='upsampling',
...
#    backbone = ResnetBuilder.build(input_shape=input_shape,input_tensor=input_tensor)
...
def  UResNet34(num_class_,INP_SHAPE_,dim_org_,CONCAT_AXIS_,d0):
    print('this is Uresnet34')
#    print(INP_SHAPE_)
    model = UResNet34T(input_shape=INP_SHAPE_)
    return model

if __name__ == '__main__':
#
    img_size_target=512
    model = UResNet34T(input_shape=(1,img_size_target,img_size_target))
#    model.summary()